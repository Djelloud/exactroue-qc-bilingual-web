...
const translations = {
  fr: {
    ...
    'testi.q1': 'Excellent service et prix très raisonnable pour un travail de qualité supérieure.',
    'testi.q2': 'Réparé ma jante fissurée et voilée rapidement et efficacement. Merci les routes de Montréal !',
    'testi.q3': 'Travail incroyable sur mes grilles BMW, peintes noir brillant. A1 !',
    'testi.r1': 'Client Google vérifié',
    'testi.r2': 'Client Google vérifié',
    'testi.r3': 'Client Google vérifié',
    ...
    'faq.a4': 'Powder coat, peinture liquide, hypersilver, tricoat et finitions diamantées.',
    ...
    'footer.hours': 'Lun–Mer 8h–17h, Jeu 8h–19h, Ven 8h–14h',
    'footer.address': '1420 Boul Hymus, Dorval, QC H9P 1J6',
  ...
  en: {
    ...
    'testi.q1': 'Great service and very good price for A1 job!',
    'testi.q2': 'Fixed my cracked and bent mag (thanks Montreal roads!) fast and efficiently.',
    'testi.q3': 'Awesome job done on my BMW grilles, painted gloss black. A1!',
    'testi.r1': 'Verified Google Customer',
    'testi.r2': 'Verified Google Customer',
    'testi.r3': 'Verified Google Customer',
    ...
    'faq.a4': 'Powder coat, liquid paint, hypersilver, tricoat and diamond-cut.',
    ...
    'footer.hours': 'Mon–Wed 8am–5pm, Thu 8am–7pm, Fri 8am–2pm',
    'footer.address': '1420 Boul Hymus, Dorval, QC H9P 1J6',
